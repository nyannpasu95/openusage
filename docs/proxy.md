...
OhMyUsage can route provider and plugin HTTP requests through an optional proxy.
...
- Restart OhMyUsage after changing the file.
...
This applies to provider and plugin HTTP requests that go through OhMyUsage's built-in HTTP client.
